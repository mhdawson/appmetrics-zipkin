...
exports.aroundCallback = function(args, context, hookBefore, hookAfter, namespace) {
  ...
  if (namespace) {
    args[position] = namespace.bind(args[position]);
  }
};
...
exports.before = function(target, meths, hookBefore, namespace) {
  ...
  meths.forEach(function(methodName) {
    ...
    if (namespace) {
      newFunc = namespace.bind(newFunc);
    }
...
exports.around = function(target, meths, hookBefore, hookAfter, namespace) {
  if (!Array.isArray(meths)) {
    meths = [meths];
  }
